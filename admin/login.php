				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								...
								<p class="lead">亿贝网络后台管理系统</p>
							</div>
							<form class="form-auth-small" action="login_p.php" method="post">
								<div class="form-group">
									<label for="signin-email" class="control-label sr-only">用户名</label>
									<input type="text" class="form-control" id="signin-email" name="username" value="" placeholder="用户名">
								</div>
								<div class="form-group">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">欢迎来到亿贝后台管理系统</h1>
							<p>Welcome to YIBELL</p>
						</div>
					</div>
