			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="call.php" class="active"><i class="lnr lnr-chart-bars"></i> <span>亿贝CALL</span></a></li>
		...
		<!-- MAIN -->
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<!--END OVERVIEW-->
					<h2 class="panel-title" style="margin-bottom: 20px">亿贝CALL</h2>
					<div><h4><a href="call_add.php?id=<?php echo $row['id']?>">添加</a></h4></div>
					
                     <?php 
					    $sql="select * from yb_call order by id asc";
					    $res=mysql_query($sql);
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<span>
									    ...
									    <a href="call_modify.php?id=<?php echo $row['id']?>" style="float:right">修改</a>

									    <a href="call_del.php?id=<?php echo $row['id']?>" style="float:right">删除</a>
