					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel">
								...
								<?php 
							        $id=$_GET['id'];
									$sql="select * from yb_news where id='$id'";
									$res=mysql_query($sql);
									$row=mysql_fetch_array($res);
								 ?>
									<h4>修改动态</h4>
									<form action="news_xg.php?id=<?php echo $row['id']?>" method="post">

									<p>标题：<input type="text" name="name" value="<?php echo $row['name']?>"></p>
									<p>日期：<input type="text" name="date" value="<?php echo $row['date']?>"></p>
									<p>路径：<input type="text" name="url" value="<?php echo $row['url']?>"></p>
									<p>作者：<input type="text" name="user" value="<?php echo $row['user']?>"></p>
