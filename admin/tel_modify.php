					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel">
								...
								<?php 
							        $id=$_GET['id'];
									$sql="select * from yb_tel where id='$id'";
									$res=mysql_query($sql);
									$row=mysql_fetch_array($res);
								 ?>
									<form action="tel_xg.php?id=<?php echo $row['id']?>" method="post">

									<p>标题：<input type="text" name="title" value="<?php echo $row['title']?>"></p>
									<p>内容：<textarea row="3" cols="80" name="content" ><?php echo $row['content']?></textarea> </p>
