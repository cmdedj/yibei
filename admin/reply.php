					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="exit.php"><i class="lnr lnr-cog"></i> <span>退出</span></a></li>
							</ul>
						</li>
						...
						<li>
							...
							<div id="subPages" class="collapse in">
								<ul class="nav">
									...
									<li><a href="reply.php" class="active">回复留言</a></li>
								</ul>
							</div>
						</li>
						...
						<div class="col-md-8">
							...
							<div class="panel panel-headline">
								<div class="panel-heading">
									<h3 class="panel-title">Email:<?php echo $row['email']; ?></h3>
									<p>电话:<?php echo $row['iphone']; ?></p>
									<p class="panel-subtitle" style="float: right;">
									<a href="tel_modify.php?id=<?php echo $row['id'] ?>">回复</a>&nbsp;
									<a href="reply_del.php?id=<?php echo $row['id'] ?>">删除</a>
									</p>
								</div>
