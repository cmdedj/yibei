			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class=""><i class="lnr lnr-file-empty"></i> <span>留言板</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
						...
						<li><a href="help.php" class="active"><i class="lnr lnr-dice"></i> <span>帮助中心</span></a></li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<h4 ><a href="helpadd.php">添加</a></h4>
					<?php 
						$sql="select * from yb_help order by id desc";
						$res=mysql_query($sql);
						...
						<div class="col-md-8">
							...
							<div class="panel panel-headline">
								<div class="panel-heading">
									...
									<a href="help_modify.php?id=<?php echo $row['id'] ?>">修改</a>&nbsp;
									<a href="help_del.php?id=<?php echo $row['id'] ?>">删除</a>
									</p>
								</div>
