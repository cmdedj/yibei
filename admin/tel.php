	...
	<div id="wrapper">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">亿贝通讯录</h3>
					<h4 ><a href="teladd.php">添加</a></h4>
					<?php 
						$sql="select * from yb_tel order by id desc";
						$res=mysql_query($sql);
						...
						<div class="col-md-8">
							...
							<div class="panel panel-headline">
								<div class="panel-heading">
									...
									<a href="tel_modify.php?id=<?php echo $row['id'] ?>">修改</a>&nbsp;
									<a href="tel_del.php?id=<?php echo $row['id'] ?>">删除</a>
									</p>
								</div>
